...
// GET /api/reports/supplier?epochMs=1724352000000&format=xlsx|csv|pdf
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(body, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename=supplier-report-${formatEpochToDate(Number(epochMs))} ${formatEpochToTime(Number(epochMs))}.${fileExt}`,
    },
  });
}
