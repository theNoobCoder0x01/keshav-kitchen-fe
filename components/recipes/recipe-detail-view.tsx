...
import { Clock, DollarSign, Users, ChefHat, Tag } from "lucide-react";
...
export const RecipeDetailView = forwardRef<HTMLDivElement, RecipeDetailViewProps>(
    ...
    return (
      ...
      >
        ...
        <div className="text-center space-y-4">
          <h1 className={`${isPrintMode ? "text-3xl" : "text-4xl"} font-bold text-gray-900`}>
            {recipe.name}
          </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {recipe.prepTime && (
                  <div>
                    ...
                    <p className="text-lg font-medium">{recipe.prepTime} minutes</p>
                  </div>
                )}
                {recipe.cookTime && (
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Cook Time</p>
                    <p className="text-lg font-medium">{recipe.cookTime} minutes</p>
                  </div>
                )}
              </div>
            </CardContent>
                ...
                {recipe.instructions.split('\n').map((instruction, index) => {
                  ...
                  return (
                    <div key={index} className="flex gap-4 mb-4">
                      ...
                      <p className="text-gray-700 leading-relaxed pt-1">{trimmedInstruction}</p>
                    </div>
                  );
                })}
              </div>
